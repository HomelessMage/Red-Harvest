		...
		if ((name player find "[RC" !=-1) || (name player find "RC]" !=-1) || (name player find "[ARC" !=-1) || (name player find "ARC]" !=-1) || (name player find "[ARF" !=-1) || (name player find "ARF]") || (name player find "ARF") || (name player find "ARC") || (name player find "RC")) then {
