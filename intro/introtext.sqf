...
_role1 = "Добро пожаловать на Звезду: Чернарусь";
_role1names = [profileName];
_role2 = "Игровой проект Звезда";
_role2names = ["Свобода игрокам"];
_role3 = "Основатели";
_role3names = ["Демьян, Adler, LSRB"];
//_role4 = "Посетите нашу группу VK";
//_role4names = ["https://vk.com/1project_everest1"];
_role5 = "Присоединяйтесь к Discord";
_role5names = ["https://discord.gg/6Kk74CR"];
_role6 = "Удачной игры!";
