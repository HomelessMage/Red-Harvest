...
if(HG_WHITELISTED_ENABLED) then
{
    {
	    _x ctrlShow true;
	} forEach [HG_WL_HEADER,HG_WL_HEADER_TEXT,HG_WL_BACK,HG_WL_BACK_FRAME,HG_WL_LINE,HG_WL_SIDE_COMBO,HG_WL_UID_LIST,HG_WL_UID_EDIT,HG_WL_UID_ADD,HG_WL_UID_REMOVE];
