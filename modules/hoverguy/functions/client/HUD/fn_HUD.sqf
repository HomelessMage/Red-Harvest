...
switch(_mode) do
{
	...
	case 1:
	{
		HG_HUD_MONEY_TEXT ctrlSetText format["%1 (%2)",([(player getVariable HG_CASH_VAR)] call BIS_fnc_numberText),([(player getVariable HG_BANK_VAR)] call BIS_fnc_numberText)];
	};
	// HUD XP Update
	case 2:
	{
