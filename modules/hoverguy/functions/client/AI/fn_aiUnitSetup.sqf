...
if((typeName _ai) != "OBJECT") exitWith {diag_log format[(localize "STR_HG_ERR_NOT_OBJECT"),"modules\hoverguy\functions\client\AI\fn_aiUnitSetup.sqf"];};
if(!(_ai isKindOf "Man")) exitWith {diag_log format[(localize "STR_HG_ERR_NOT_MAN"),"modules\hoverguy\functions\client\AI\fn_aiUnitSetup.sqf"];};
if(isPlayer _ai) exitWith {diag_log format[(localize "STR_HG_ERR_PLAYER"),"modules\hoverguy\functions\client\AI\fn_aiUnitSetup.sqf"];};
