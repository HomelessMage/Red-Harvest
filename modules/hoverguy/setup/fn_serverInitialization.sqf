...
if(HG_SAVING_EXTDB) then
{
	...
	HG_fnc_asyncCall = compileFinal preprocessFileLineNumbers "modules\hoverguy\functions\server\fn_asyncCall.sqf";
	HG_fnc_extDBInit = compileFinal preprocessFileLineNumbers "modules\hoverguy\functions\server\fn_extDBInit.sqf";
