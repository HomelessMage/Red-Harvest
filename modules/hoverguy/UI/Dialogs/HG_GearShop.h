...
class HG_GearShop
{
	...
	class Controls
	{
		...
		class ResetButton: HG_RscActivePicture
		{
			idc = HG_GEAR_RESET_IDC;
			text = "modules\hoverguy\UI\Icons\reset.paa";
		...
		{
			idc = HG_GEAR_BUY_IDC;
			text = "modules\hoverguy\UI\Icons\buy.paa";
		...
		{
			idc = HG_GEAR_MC_IDC;
			text = "modules\hoverguy\UI\Icons\mycash.paa";
