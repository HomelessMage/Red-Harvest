...
class HG_AdminMenu
{
	...
	class ControlsBackground
	{
		...
		{
			text = "modules\hoverguy\UI\Icons\medal.paa";
			x = 0.505156 * safezoneW + safezoneX;
		...
		{
			text = "modules\hoverguy\UI\Icons\xp.paa";
			y = 0.621 * safeZoneH + safeZoneY;
		};
		
		class KillsIcon: RankIcon
		{
			text = "modules\hoverguy\UI\Icons\gun.paa";
			y = 0.654 * safeZoneH + safeZoneY;
		};
		
		class CashIcon: RankIcon
		{
			text = "modules\hoverguy\UI\Icons\money.paa";
			y = 0.687 * safeZoneH + safeZoneY;
		};
		
		class BankIcon: RankIcon
		{
			text = "modules\hoverguy\UI\Icons\bank.paa";
	...
	class Controls
	{
		...
		{
			idc = HG_ADM_KILL_IDC;
			text = "modules\hoverguy\UI\Icons\dead.paa";
		...
		class AddUIDButton: RefreshButton
		{
			...
			text = "modules\hoverguy\UI\Icons\add_bis.paa";
		...
		class RemoveButton: RefreshButton
		{
			...
			text = "modules\hoverguy\UI\Icons\sub_bis.paa";
