		...
		switch _ctrlEditTextSegmentType do {
			...
			default {
				_items = [
					[
						"Emojis",
						"modules\cau\extendedchat\data\images\ico_emoji.paa",
						"","",
					...
					[
						"Mentions",
						"modules\cau\extendedchat\data\images\ico_mention.paa",
						"","",
					...
					[
						"Commands",
						"modules\cau\extendedchat\data\images\ico_command.paa",
						"","",
