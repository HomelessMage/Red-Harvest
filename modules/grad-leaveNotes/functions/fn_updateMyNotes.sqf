...
if (_mode == "add") then {
    ...
    _action = [_readactionName, "Прочесть записку", GRAD_leaveNotes_moduleRoot + "\data\read.paa", _readAction, {true}, {}, [[_message, _noteID, _handwriting],GRAD_leaveNotes_fnc_readNote]] call ace_interact_menu_fnc_createAction;
    ...
    _action = [_dropactionName, "Бросить записку", GRAD_leaveNotes_moduleRoot + "\data\drop.paa", _dropAction, {true}, {}, [_noteID, _message, _handwriting]] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "ACE_Equipment", "GRAD_leaveNotes_mainAction", _nodeName], _action] call ace_interact_menu_fnc_addActionToObject;

    //destroy
    _destroyactionName = _nodeName + "_destroy";
    _action = [_destroyactionName, "Порвать записку", GRAD_leaveNotes_moduleRoot + "\data\destroy.paa", {(_this select 2) call GRAD_leaveNotes_fnc_destroyNote}, {true}, {}, [_noteID]] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions", "ACE_Equipment", "GRAD_leaveNotes_mainAction", _nodeName], _action] call ace_interact_menu_fnc_addActionToObject;
