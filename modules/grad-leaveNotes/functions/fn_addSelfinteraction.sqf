...
_action = ["GRAD_leaveNotes_mainAction", "Записки", GRAD_leaveNotes_moduleRoot + "\data\note.paa", {}, _mainCondition] call ace_interact_menu_fnc_createAction;
[player, 1, ["ACE_SelfActions","ACE_Equipment"], _action] call ace_interact_menu_fnc_addActionToObject;

//add write action
_writeCondition = {player getVariable ["GRAD_leaveNotes_canWriteNotes", GRAD_leaveNotes_canWriteDefault]};
_action = ["GRAD_leaveNotes_writeNote", "Создать записку", GRAD_leaveNotes_moduleRoot + "\data\write.paa", {[[],GRAD_leaveNotes_fnc_writeNote] call GRAD_leaveNotes_fnc_delayedCall}, _writeCondition] call ace_interact_menu_fnc_createAction;
