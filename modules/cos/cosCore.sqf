...
for "_i" from 1 to _civilians do {
	if (!(server getvariable _trigID)) exitwith {_isActive=false;};
		...
		_civilianArray set [count _civilianArray,_grp];
				...
				null =[_unit] execVM "modules\cos\addScript_Unit.sqf";
...
null =[_veh] execVM "modules\cos\addScript_Vehicle.sqf";
null =[_unit] execVM "modules\cos\addScript_Unit.sqf";
...
null =[_civilianArray,_PatrolVehArray,_roadPosArray] execVM "modules\cos\CosPatrol.sqf";
