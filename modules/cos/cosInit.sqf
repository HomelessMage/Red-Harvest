...
breakPatrol_FNC=compile preprocessFileLineNumbers "modules\cos\patrolFnc.sqf";unitScript_FNC=compile preprocessFileLineNumbers "modules\cos\addScript_Unit.sqf";vehScript_FNC=compile preprocessFileLineNumbers "modules\cos\addScript_Vehicle.sqf";
...
// Create a trigger over town	
		...
		_trigAct=format ["null= [%1] execVM ""modules\cos\cosCore.sqf"";server setvariable [%2,true];",str _foo,str _var];
...
null=[] execVM "modules\cos\localScript.sqf";// This shows messages for players during multiplayer
