...
_openGarage = ["OpenGarage", localize "STR_HG_GARAGE", "modules\hoverguy\UI\Icons\garage.paa",
	{
		[_object, player, nil, "HG_WESTGarage"] call HG_fnc_dialogOnLoadGarage;
	},
	{playerSide == WEST},{},[_object],[0,0,0], 100] call ace_interact_menu_fnc_createAction;  
...
_storeVehicle = ["StoreVehicle", localize "STR_HG_GARAGE_PARK", "modules\hoverguy\UI\Icons\garage.paa",
	{
		[_object, player, nil, "HG_WESTGarage"] call HG_fnc_storeVehicleClient;
	},
	{playerSide == WEST},{},[_object],[0,0,0], 100] call ace_interact_menu_fnc_createAction;  
